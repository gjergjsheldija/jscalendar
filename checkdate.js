function IsValidDate(objDate,sFormat)
{
   ...
   var bOk = true;
   var bDebug = true;
   var sErrorMsg= "Data e dhene Gabim!" + ":\n";  /* EL140802 */
   ...
   {// if (bDebug)
     { //alert("wrong sFormat");
	   sErrorMsg+= "Gabim ne formatin e dates" + "\n"; /* EL140802 */
     }
     bOk = false;
   }
   ...
   switch (nSize)
   {
     ...
     { if (isNaN(sDate) == true)
       { //alert("no numeric sDate");
		 sErrorMsg+= "Gabim, data jo numerike" + "\n"; /* EL140802 */
       }
       else
       {
         switch (sLang)
